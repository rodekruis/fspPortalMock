...
def process_csv(csv_file):
    ...
    # Randomly delete between 1 and 3 rows (if more than 20 rows and environment variable is set)
    if len(df) > 20 and os.getenv('ENABLE_RANDOM_ROW_DELETION', 'false').lower() == 'true':
